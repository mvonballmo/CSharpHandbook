...
* If you implement Dipose, implement Finalize only if you actually have costly external resources. 
...
- Section on explicit initialization (use in hiding/interface reduction)
...
7.18.2	Capturing Unstable Variables/”Access to Modified Closure”
...
7.18.3	Enumeration Run-time Errors
...
7.20	Using Optional Parameters
***TODO***
...
## Using “var”
This section applies to .NET 3.5 and newer.
The introduction of the keyword var for implicitly-typed variables is a boon to writing legible code. Using var can eliminate a lot of repeated text from code and make the intent much clearer. However, the goal is to make code more legible, not just to use implicit typing as much as possible. 
...
7.25.6	Specific Exception Types
...
7.30	Marking Members as Obsolete
*** TODO ***
