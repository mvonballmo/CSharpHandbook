...
* Do not mix and match conversion operators and types. The type MetaString can convert to System.String but should not convert to System.Int32. Instead, use a constructor ot initialize from types that are not in the same domain.
